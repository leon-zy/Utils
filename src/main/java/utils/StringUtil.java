...
public class StringUtil {
    ...
    public static Map<String, String> toMap(String value, String splitCharacter) {
        ...
        if (isNotBlank(value)) {
            String[] splitArray = value.split("" + splitCharacter); //value.split("\\" + splitCharacter);
    ...
    public static <T> String joinEntityPropertyString(String splitString, String propertyName, Collection<T> entities) {
        ...
        if (entities != null && entities.size() > 0) {
            ...
            while(var4.hasNext()) {
                ...
                try {
                    PropertyDescriptor pd = new PropertyDescriptor(propertyName, t.getClass());//BeanUtils.getPropertyDescriptor(t.getClass(), propertyName);
